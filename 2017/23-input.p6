...
# a is "debug flag" set to 0 for debugging
# b is the min
# c is the max
# d is the first multiple
# e is the second multiple
# f is a flag whether we matched
# g is a temp working variable
# h is the number of matches

# between b and c

# Looking for numbers between b and c in steps of 17
#  where d * e == b
#    and e <= b
#    and d <= b
...
last D if %r<g> > %r<b>;	# xx jgz g *to 24*
			%r<e> -= -1;			# 16 sub e -1
			%r<g>  = %r<e>;			# 17 set g e
			%r<g> -= %r<b>;			# 18 sub g b
